...
%add=address
%dir=directory
add_dir = '/Users/aqib/Desktop/github/disp-flow/Exps/isovisc-misc-disp/beta70/Exp4_Re703/'; % Dont forget to put \  also the Nx,...should be even

Gate_valve_image=72;
num_last_im_cam0= 182; 
NxStart=  76;
NxEnd=1675; 
NyStart=  7; 
NyEnd=  19;
Nxcenter= 9;  %Nxcenter is the location where the tape has been added to the downstream of the pipe xtape=1570 mm
Nxgate=1695; %the center of the gate valve indicated by a black line in the image xgate=0 mm
Framerate=8; 

Gate_valve_left = 1675; %leftmost pixel of gate valve
Gate_valve_right = 1721; % rightmost pixel of gate valve
