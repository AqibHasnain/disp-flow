...
%add=address
%dir=directory
add_dir = '/Users/aqib/Desktop/github/disp-flow/Exps/isovisc-misc-disp/beta0/Exp30_Re703/'; % Dont forget to put \  also the Nx,...should be even
...
axes('Position',[.2 .2 .7 .7])
plot(time_Vf,Vf,'ko','markerfacecolor','k');
