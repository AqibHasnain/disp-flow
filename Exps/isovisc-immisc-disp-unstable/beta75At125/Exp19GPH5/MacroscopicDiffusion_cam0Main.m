...
%add=address
%dir=directory
add_dir = '/Users/aqib/Desktop/github/disp-flow/Exps/isovisc-immisc-disp-unstable/beta75At125/Exp19GPH5/';

Gate_valve_image=66;
num_last_im_cam0= 230; 
NxStart=  200;
NxEnd=1719; 
NyStart=  5; 
NyEnd=  21;
Nxcenter= 66;  %Nxcenter is the location where the tape has been added to the downstream of the pipe xtape=1570 mm
Nxgate=1744; %the center of the gate valve indicated by a black line in the image xgate=0 mm
Framerate=12; 

Gate_valve_left = 1719; %leftmost pixel of gate valve
Gate_valve_right = 1764; % rightmost pixel of gate valve
...
title('$\beta=75^{\circ}$','Interpreter','latex');
...
for j=1:length(mean_scaled_im_cam0(:,1)) 
    ...
    for i=length(mean_scaled_im_cam0(1,:)):-1:2
